...
function renderPriceListPreview(rows, cols) {
  ...
  wrap.innerHTML = `
    <div class="card-title" style="margin-bottom:8px;font-size:13px;">Распознано позиций: ${rows.length} <span class="demo-flag" style="background:#f2f4f7;color:var(--text-dim);">${mapNote}<